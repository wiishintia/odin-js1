// var gameCard = document.getElementsByClassName("game")[0];

// function playerClick(e){
//    if (e.target.tagName === 'IMG'){
//        var playerSelection = e.target.className;
//        console.log(playerSelection, 'is clicked');
//    }
// };
...
//     var computer = documnet.getElementById('computer');

//     if (playerSelection == computerSelection){
//         return document.result.appendChild("It's a tie");
//     } else if (playerSelection =="rock"){
//         if (computerSelection == "paper"){
//             computerScore++;
//             document.result.remove();
//             document.result.appendChild("It's a tie");
...
//     let totalScore =0;
//     for (let i = 1; i<6;i++){
//         gameCard.addEventListener('click', playerClick);
